...
public class SidebarView extends LinearLayout {
	...
	/**
	 * The background of the sidebar view or null, if the default background is
	 * used.
	 */
	private Drawable sidebarBackground;

	/**
	 * Inflates and adds all child views, depending on the location of the
	 * sidebar.
	 * 
	 * @param inflater
	 *            The inflater, which should be used to inflate the sidebar
	 *            view, as an instance of the type {@link Inflater}. The
	 *            inflater may not be null
	 */
	private void inflateViews(final Inflater inflater) {
	...
	/**
	 * Creates a new custom view, which contains the sidebar view of a sidebar,
	 * as well as a view, which is used to visualize a shadow.
	 * 
	 * @param context
	 ...
	 *            The background of the sidebar view as an instance of the class
	 *            {@link Drawable} or null, if the default background should be
	 *            used
	 * @param shadowWidth
	 *            The width of the shadow in pixels as an {@link Integer} value.
	 *            The width must be at least 0
	 * @param shadowColor
	 *            The color of the shadow as an {@link Integer} value
	 */
	public SidebarView(final Context context, final Inflater inflater,
	 ...
	 * 
	 * @return The background of the sidebar view as an instance of the class
	 ...
	 *            class {@link Drawable} or null, if the default background
	 *            should be used
	 */
	@SuppressWarnings("deprecation")
	 ...
	 * 
	 * @return The sidebar view as an instance of the class {@link View}. The
	 *         sidebar view may not be null
	 */
