...
/**
 * A custom view, which contains the content view of a sidebar, as well as a
 * view, which is used as an overlay, while the sidebar is shown.
 * 
 * @author Michael Rapp
 * 
 * @since 1.0.0
...
public class ContentView extends FrameLayout {
	 ...
	 * 
	 * @param inflater
	 *            The inflater, which should be used to inflate the content
	...
	/**
	 * Creates a new custom view, which contains the content view of a sidebar,
	 * as well as a view, which is used as an overlay, while the sidebar is
	 * shown.
	 * 
	 * @param context
	 ...
	 * 
	 * @return The current transparency of the overlay as a {@link Float} value.
	 *         If set to 0.0, the overlay is completely transparent, if set to
	 *         1.0, the overlay is not transparent at all
	 */
	 ...
	 *            value. If set to 0.0, the overlay will be completely
	 *            transparent, if set to 1.0, the overlay will not be
	 *            transparent at all
	 */
	 ...
	 * 
	 * @return The content view, as an instance of the class {@link View}. The
	 *         content view may not be null
	 */
