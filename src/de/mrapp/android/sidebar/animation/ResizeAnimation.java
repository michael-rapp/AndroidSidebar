...
public class ResizeAnimation extends Animation {
	 ...
	 * 
	 * @param view
	 *            The view, which should be resized, as an instance of the class
	 *            {@link View}. The view may not be null
	 * @param widthOffset
	 *            The offset, the view should be resized by, as a {@link Float}
	 *            value. If the offset is negative, the view's width will become
	 *            decreased, if the offset is positive, the width will become
	 *            increased
	 */
	public ResizeAnimation(final View view, final float widthOffset) {
