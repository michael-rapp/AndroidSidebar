...
/**
 * Defines the interface, a class, which should be notified when a sidebar
 * becomes shown or hidden, must implement.
 * 
 * @author Michael Rapp
 *
 * @since 1.0.0
...
public interface SidebarListener {
	 ...
	 * 
	 * @param sidebar
	 *            The observed sidebar as an instance of the class
	 *            {@link Sidebar}. The sidebar may not be null
	 */
