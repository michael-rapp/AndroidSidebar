...
/**
 * Contains all possible drag modes, which can be applied on a sidebar to
 * specify, on which regions dragging should be recognized.
 * 
 * @author Michael Rapp
 * 
 * @since 1.0.0
...
public enum DragMode {
	...
	/**
	 * If dragging should be recognized on the sidebar, as well as on the
	 * content.
	 */
	BOTH(0),
